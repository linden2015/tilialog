...
public class LogTest {
    ...
    public void overlaps() {
        ...
        assertTrue(
            new Log("AA-1", LocalTime.parse("09:00"), LocalTime.parse("09:15"), "")
                .overlaps(new Log("AA-1", LocalTime.parse("09:10"), LocalTime.parse("09:30"), ""))
        );
        // Within
        assertTrue(
            new Log("AA-1", LocalTime.parse("09:00"), LocalTime.parse("09:15"), "")
                .overlaps(new Log("AA-1", LocalTime.parse("09:05"), LocalTime.parse("09:10"), ""))
        );
        // Not ended before other starts
        assertTrue(
            new Log("AA-1", LocalTime.parse("09:00"), LocalTime.parse("09:15"), "")
                .overlaps(new Log("AA-1", LocalTime.parse("08:45"), LocalTime.parse("09:05"), ""))
        );
        // Adjacent 1
        assertFalse(
            new Log("AA-1", LocalTime.parse("09:00"), LocalTime.parse("09:15"), "")
                .overlaps(new Log("AA-1", LocalTime.parse("09:15"), LocalTime.parse("09:30"), ""))
        );
        // Adjacent 2
        assertFalse(
            new Log("AA-1", LocalTime.parse("09:00"), LocalTime.parse("09:15"), "")
                .overlaps(new Log("AA-1", LocalTime.parse("08:45"), LocalTime.parse("09:00"), ""))
        );
    }
}
